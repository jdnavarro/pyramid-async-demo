...
def bind():
    ...
    _attrs_153326316 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#tutorials\np3\ns.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_153277772 = _loads('(dp1\nVmedia\np2\nVscreen\np3\nsVcharset\np4\nVutf-8\np5\nsVhref\np6\nV${request.application_url}/static/pylons.css\np7\nsVrel\np8\nVstylesheet\np9\nsVtype\np10\nVtext/css\np11\ns.')
    _attrs_153276684 = _loads('(dp1\n.')
    _attrs_153277196 = _loads('(dp1\nVcontent\np2\nVpython web application\np3\nsVname\np4\nVkeywords\np5\ns.')
    _attrs_153303852 = _loads('(dp1\nVclass\np2\nVlinks\np3\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_153326956 = _loads('(dp1\n.')
    _attrs_153302636 = _loads('(dp1\nVaction\np2\nVhttp://docs.pylonshq.com/pyramid/dev/search.html\np3\nsVmethod\np4\nVget\np5\ns.')
    _attrs_153276780 = _loads('(dp1\n.')
    _attrs_153303212 = _loads('(dp1\nVtype\np2\nVsubmit\np3\nsVid\np4\nVx\nsVvalue\np5\nVGo\np6\ns.')
    _attrs_153326764 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#change-history\np3\ns.')
    _attrs_153301836 = _loads('(dp1\nVid\np2\nVfooter\np3\ns.')
    _attrs_153301292 = _loads('(dp1\nVclass\np2\nVapp-name\np3\ns.')
    _attrs_153276524 = _loads('(dp1\n.')
    _attrs_153277964 = _loads('(dp1\nVmedia\np2\nVscreen\np3\nsVcharset\np4\nVutf-8\np5\nsVhref\np6\nVhttp://fonts.googleapis.com/css?family=Neuton&subset=latin\np7\nsVrel\np8\nVstylesheet\np9\nsVtype\np10\nVtext/css\np11\ns.')
    _attrs_153301516 = _loads('(dp1\n.')
    _attrs_153303628 = _loads('(dp1\n.')
    _attrs_153277004 = _loads('(dp1\nVcontent\np2\nVtext/html;charset=UTF-8\np3\nsVhttp-equiv\np4\nVContent-Type\np5\ns.')
    _attrs_153279212 = _loads('(dp1\nVclass\np2\nVtop align-center\np3\ns.')
    _attrs_153326060 = _loads('(dp1\n.')
    _attrs_153302156 = _loads('(dp1\nVid\np2\nVleft\np3\nsVclass\np4\nValign-right\np5\ns.')
    _attrs_153302924 = _loads('(dp1\nVname\np2\nVq\nsVvalue\np3\nV\nsVtype\np4\nVtext\np5\nsVid\np6\nVq\ns.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_153326508 = _loads('(dp1\n.')
    _attrs_153325868 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#api-documentation\np3\ns.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_153304908 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#narrative-documentation\np3\ns.')
    _attrs_153280268 = _loads('(dp1\nVclass\np2\nVmiddle align-center\np3\ns.')
    _attrs_153279436 = _loads('(dp1\nVid\np2\nVmiddle\np3\ns.')
    _attrs_153301900 = _loads('(dp1\nVclass\np2\nVbottom\np3\ns.')
    _attrs_153304652 = _loads('(dp1\n.')
    _attrs_153327852 = _loads('(dp1\n.')
    _attrs_153302412 = _loads('(dp1\n.')
    _attrs_153302828 = _loads('(dp1\nVid\np2\nVright\np3\nsVclass\np4\nValign-left\np5\ns.')
    _attrs_153304108 = _loads('(dp1\n.')
    _attrs_153277580 = _loads('(dp1\nVhref\np2\nV${request.application_url}/static/favicon.ico\np3\nsVrel\np4\nVshortcut icon\np5\ns.')
    _attrs_153278892 = _loads('(dp1\nVid\np2\nVtop\np3\ns.')
    _attrs_153280460 = _loads('(dp1\nVid\np2\nVbottom\np3\ns.')
    _attrs_153328396 = _loads('(dp1\nVclass\np2\nVfooter\np3\ns.')
    _attrs_153328108 = _loads('(dp1\nVhref\np2\nVirc://irc.freenode.net#pyramid\np3\ns.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_153277388 = _loads('(dp1\nVcontent\np2\nVpyramid web application\np3\nsVname\np4\nVdescription\np5\ns.')
    _attrs_153279852 = _loads('(dp1\nVsrc\np2\nV${request.application_url}/static/pyramid.png\np3\nsVheight\np4\nV169\np5\nsVwidth\np6\nV750\np7\nsValt\np8\nVpyramid\np9\ns.')
    _attrs_153325612 = _loads('(dp1\n.')
    _attrs_153327404 = _loads('(dp1\n.')
    _attrs_153327212 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#sample-applications\np3\ns.')
    _attrs_153259916 = _loads('(dp1\nVxml:lang\np2\nVen\np3\nsVxmlns\np4\nVhttp://www.w3.org/1999/xhtml\np5\ns.')
    _attrs_153301036 = _loads('(dp1\nVclass\np2\nVapp-welcome\np3\ns.')
    _attrs_153327660 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#support-and-development\np3\ns.')
    _attrs_153279532 = _loads('(dp1\n.')
    _attrs_153278604 = _loads('(dp1\nVid\np2\nVwrap\np3\ns.')
    _attrs_153278156 = _loads('(dp1\nVmedia\np2\nVscreen\np3\nsVcharset\np4\nVutf-8\np5\nsVhref\np6\nVhttp://fonts.googleapis.com/css?family=Nobile:regular,italic,bold,bolditalic&subset=latin\np7\nsVrel\np8\nVstylesheet\np9\nsVtype\np10\nVtext/css\np11\ns.')
    _attrs_153304396 = _loads('(dp1\nVhref\np2\nVhttp://pylonshq.com\np3\ns.')
    def render(econtext, rcontext=None):
        ...
        attrs = _attrs_153277964
        _write(u'<link href="http://fonts.googleapis.com/css?family=Neuton&amp;subset=latin" rel="stylesheet" type="text/css" media="screen" charset="utf-8" />\n\t')
        attrs = _attrs_153278156
        u'request.application_url'
        ...
        _tmp1 = _lookup_attr(econtext['request'], 'application_url')
        _tmp = _tmp1
        ...
        if (_tmp is not None):
            ...
            if ('>' in _tmp):
                _tmp = _tmp.replace('>', '&gt;')
            _write(_tmp)
        _write(u'/static/ie6.css" type="text/css" media="screen" charset="utf-8" />\n\t<![endif]-->\n</head>\n')
        attrs = _attrs_153276684
        _write(u'<body>\n\t')
        attrs = _attrs_153278604
        _write(u'<div id="wrap">\n\t\t')
        attrs = _attrs_153278892
        _write(u'<div id="top">\n\t\t\t')
        attrs = _attrs_153279212
        _write(u'<div class="top align-center">\n\t\t\t\t')
        attrs = _attrs_153279532
        _write(u'<div>')
        attrs = _attrs_153279852
        "join(value('request.application_url'), u'/static/pyramid.png')"
        _write(u'<img')
        _tmp1 = ('%s%s' % (_lookup_attr(econtext['request'], 'application_url'), u'/static/pyramid.png', ))
        if (_tmp1 is _default):
            _tmp1 = u'${request.application_url}/static/pyramid.png'
        if ((_tmp1 is not None) and (_tmp1 is not False)):
            if (_tmp1.__class__ not in (str, unicode, int, float, )):
                _tmp1 = unicode(_translate(_tmp1, domain=_domain, mapping=None, target_language=target_language, default=None))
            else:
        ...
        attrs = _attrs_153279436
        _write(u'<div id="middle">\n\t\t\t')
        attrs = _attrs_153280268
        _write(u'<div class="middle align-center">\n\t\t\t\t')
        attrs = _attrs_153301036
        _write(u'<p class="app-welcome">\n\t\t\t\t\tWelcome to ')
        attrs = _attrs_153301292
        u'project'
